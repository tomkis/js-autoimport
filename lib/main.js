...
import PickerElement from './picker/PickerElement.js'
...
export function activate() {
  ...
  atom.views.addViewProvider(Picker, (model) => {
    return new PickerElement().initialize(model);
  });
  importRepository.setPicker(new Picker());
}
